...
public class Q10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Locate button
        Button answer = findViewById(R.id.q10_answer_button);
        ...
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RadioGroup q10Choices = findViewById(R.id.q10_choices);

                //Identifies the correct answer's radio4 button
                RadioButton correctAnswer = findViewById(R.id.q10_choice2_radio_button);

                //increments the correct answer if necessary and displays custom toast
                if (q10Choices.getCheckedRadioButtonId() == -1) {
                    ...
                    toastText.setText(R.string.toast_incorrect_10);
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //Go to results activity and pass value of correct answers
                        Intent intent = new Intent(Q10Activity.this, ResultsActivity.class);
